...
# ============================================================================
# Prepare HAM10000 data (90% train split)
# ============================================================================
print("\n" + "="*80)
print("Preparing HAM10000 Dataset (90% train split)")
print("="*80 + "\n")
...
print(f"DDI Val Dataset Size: ", len(ddi_val_data))

# ============================================================================
# Combine HAM10000 (90% train) + DDI train for joint training
# ============================================================================
print("\n" + "="*80)
print("Combining HAM10000 (90% train) + DDI Train for Joint Training")
print("="*80 + "\n")

combined_train_data = ConcatDataset([ham_train_data, ddi_train_data])
print(f"Combined Training Dataset Size: {len(combined_train_data)}")
print(f"  - HAM10000 train: {len(ham_train_data)}")
print(f"  - DDI train: {len(ddi_train_data)}\n")
...
# Initialize early stopping (using DDI validation)
...
# ============================================================================
# Joint Training on Combined Data (up to 100 epochs)
# ============================================================================
print("\n" + "="*80)
print("Joint Training on Combined HAM10000 + DDI Data (DINO)")
print("="*80 + "\n")

joint_epochs = 100
for epoch in range(joint_epochs):
    print(f"Epoch {epoch+1}\n-------------------------------")
    train(model, combined_train_dataloader, optimizer, loss_fn, device)
    
    # Validation and early stopping (using DDI validation)
...
print(f"Loaded best model (Best DDI Val F1: {early_stopping.best_score:.4f})")

print("\n" + "="*80)
print("Joint Training Pipeline Finished!")
print("="*80)
