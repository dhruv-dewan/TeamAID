...
# ============================================================================
print("\n" + "="*80)
print("PHASE 1: Training on HAM10000 Dataset")
print("="*80 + "\n")
...
early_stopping_ham = EarlyStopping(patience=10, verbose=True, checkpoint_path=os.path.join(f"{BASE_DIR}/supervised", "ham_best_model.pth"))
...
model.load_state_dict(torch.load(os.path.join(f"{BASE_DIR}/supervised", "ham_best_model.pth")))
...
early_stopping_ddi = EarlyStopping(patience=10, verbose=True, checkpoint_path=os.path.join(f"{BASE_DIR}/supervised", "best_model.pth"))
